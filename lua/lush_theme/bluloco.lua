...
local dark = {
  ...
  terminalBlack         = hsl("#40444c"),
  terminalRed           = hsl("#f81141"),
  terminalGreen         = hsl("#23974a"),
  terminalYellow        = hsl("#fd7e57"),
  terminalBlue          = hsl("#285bff"),
  terminalMagenta       = hsl("#8c62fd"),
  terminalCyan          = hsl("#3a8ab2"),
  terminalWhite         = hsl("#cdd3e0"),
  terminalBrightBlack   = hsl("#8f9aae"),
  terminalBrightRed     = hsl("#fc4a6d"),
  terminalBrightGreen   = hsl("#37bd58"),
  terminalBrightYellow  = hsl("#f6be48"),
  terminalBrightBlue    = hsl("#199ffd"),
  terminalBrightMagenta = hsl("#fc58f6"),
  terminalBrightCyan    = hsl("#50acae"),
...
local light = {
  ...
  terminalRed           = hsl("#d52753"),
  terminalGreen         = hsl("#23974a"),
  terminalYellow        = hsl("#df631c"),
  terminalBlue          = hsl("#275fe4"),
  terminalMagenta       = hsl("#823ff1"),
  terminalCyan          = hsl("#27618d"),
  terminalWhite         = hsl("#b9bac1"),
  terminalBrightBlack   = hsl("#676a77"),
  terminalBrightRed     = hsl("#ff6480"),
  terminalBrightGreen   = hsl("#3cbc66"),
  terminalBrightYellow  = hsl("#c5a332"),
  terminalBrightBlue    = hsl("#0099e1"),
  terminalBrightMagenta = hsl("#ce33c0"),
  terminalBrightCyan    = hsl("#6d93bb"),
